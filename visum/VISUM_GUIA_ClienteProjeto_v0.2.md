<!-- VISUM_GUIA_ClienteProjeto_v0.2 · 12-ago-2026 -->
...
Frente encerrada e arquivo esquecido na Base é a forma mais comum de o assistente responder com informação morta. Ele não sabe que a frente acabou — para ele, um `PROJETO` na Base é um projeto ativo, e ele vai usar escopo, premissas e status de uma coisa que não existe mais.

**Ao encerrar uma frente, faça as três coisas na mesma sessão:**

1. **Feche o arquivo de projeto.** Registre a data de encerramento, o que foi entregue e o que ficou pendente ou foi descartado.
2. **Suba para o arquivo de cliente o que sobrevive à frente.** Glossário novo, particularidade de ambiente descoberta, sensibilidade aprendida. O que é da conta continua valendo depois que a frente acaba.
3. **Remova o arquivo de projeto da Base.** Guarde a cópia local se quiser histórico — mas fora da Base.

**Frente pausada não é frente encerrada.** Pausa mantém o arquivo na Base, com a data e o motivo da pausa registrados no campo de fase. Sem isso, dois meses depois ninguém lembra se o silêncio é pausa ou abandono.
...
5. **Frente encerrada sai da Base.** O que sobrevive vai para o arquivo de cliente antes da remoção.

---

*Guia v0.2 · em construção · sujeito a revisão após o piloto.*
